...
const MyJobsPage = () => {
    ...
    return (
        ...
        <NavBar/>
        <div>
            <HeroComponent title="My jobs" paragragh="Lorem ipsum dolor amet sit" button="Check my jobs!" button_url="#carouselJob0" backgroundImage="https://images.unsplash.com/photo-1662147238273-e1fe1cdb693b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1742&q=80" />
