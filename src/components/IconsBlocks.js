            ...
            <div className="h-auto md:h-screen hidden md:flex flex-col items-center justify-around mx-4 md:mx-28">
                ...
                <div className="cardsContainer mt-14 md:mt-0 grid w-screen gap-y-14 md:gap-x-8">
                    <div className="flex flex-nowrap px-8">
                        {data.map((item, index) => {
                            return <>
                                <div className="iconCardWrapper hover:scale-105 w-96 mx-2 md:mx-8 md:my-2 my-4 md:m-4 py-8 px-4 border border-b-sky-900 hover:border-b-gray-600 border-b-[3px] shadow-lg hover:shadow-xl relative ease-in duration-1000" style={{ transform: `translate(-${currentIndex * 100}%)` }} key={index}>
