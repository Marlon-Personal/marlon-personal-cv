        ...
        <>
            <div id="card-carousel" className="md:p-24 pb-16 h-screen flex flex-col justify-center">
                ...
                <div class={`flex ${isReverse ? 'md:flex-row-reverse' : 'md:flex-row'} flex-col-reverse justify-end md:justify-center md:items-center h-full`}>
                    ...
                    <div style={{ backgroundImage: `url(${data.image})` }} className="bg-center bg-cover md:animate-fade-in h-2/3 md:h-3/4 w-full flex items-center justify-center md:mt-0">
