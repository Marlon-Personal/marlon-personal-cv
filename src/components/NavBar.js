...
const NavBar = () => {
    return (
        <nav className='fixed top-0 z-20 bg-white w-screen border-b border-gray-300 flex justify-between px-4  md:px-8'>
            <span className='font-light text-3xl uppercase md:pt-1'>Marlon Agüero</span>
            <ul className='flex'>
